...
def _extract_and_format_date(item):
    ...
    # Cherche la valeur parmi toutes les variantes de clés courantes
    raw_date = (
...
def ping():
    ...
    """
    # Simple health check - ne fait AUCUN traitement lourd
    # Le cron externe appelle /api/post-now séparément si besoin
    return "pong", 200
